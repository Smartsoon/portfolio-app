...
const PostItem = ({post, onReply, className = '', isAuthUser, isReplyOpen, setIsReplyOpen}) => {

    const {parent} = post;

    return (
        <div className={`${className} topic-post`}>
            <article>
                <div className="row">
                    ...
                    <div className="topic-body">
                        <div className="topic-header">
                            <div className="topic-meta">
                                ...
                                {
                                    post.createdAt &&
                                    <div className="date-container"><span
                                        className="date">{fromNow(post.createdAt)}</span>
                                    </div>
                                }
                            </div>
                        </div>
